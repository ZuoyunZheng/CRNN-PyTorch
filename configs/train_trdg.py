...
exp_name = "CRNN_TRDG_adam1e-3"

if mode == "train":
    # Train dataset
    #train_dataroot = ["./data/trdg5", ".data/MJSYNTH"]
    #train_dataset = ["trdg", "mjsynth"]
    train_dataroot = ["./data/trdg10/horizontal/lvis"]
    train_dataset = ["trdg"]
    batch_size = [512]
    # Test datase
    ...
    epochs = 10
    samples = 4992815
    #batches_per_epoch = 2996269 / batch_size
